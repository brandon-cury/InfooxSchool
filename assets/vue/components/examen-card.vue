<template>
  <a href="#" class="card" style="width: 40px;">
    <div class="imgInfoox">
      <img :src="examen.image !== null ? '/' + examen.image : '/examens/default.png'" class="card-img-top" :alt="examen.title">
    </div>
    <div class="card-body">
      <h5 class="card-title">{{ examen.title }}</h5>
      <p class="card-text">Examen</p>
